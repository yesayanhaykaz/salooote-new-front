...
const T = {
  ...
  hy: {
    dashboard: "Վահ.", myOrders: "Պատ.", messages: "Հաղ.",
    myEvents: "Միջ.", inquiries: "Հարց.", myReviews: "Կարծ.",
    savedItems: "Պահ.", notifications: "Ծան.", settings: "Կարգ.",
    signOut: "Ելք", deleteAccount: "Ջնջ. հաշ.",
    deleteModal: {
      title: "Ջնջ. հաշ.",
      desc: "Այս գործ. անշ. է: Բոլոր տվ. կջնջվ.",
      passwordLabel: "Մուտ. գաղ. հաստ.",
      passwordPlaceholder: "Գաղ.",
      cancel: "Չեղ.",
      confirm: "Ջնջ.",
      confirming: "Ջնջ.…",
    },
