...
hy: {
  ...
  empty: "Դեռ հաղորդագրություններ չկան",
  emptyDesc: "Ուղարկեք հաղորդագրություն վաճառողին՝ զրույց սկսելու համար",
  sendFirst: "Ուղարկել առաջին հաղորդագրությունը",
  noFiltered: (s) => `${s} հաղորդագրություններ չկան`,
  awaiting: "Սպասում ենք վաճառողի պատասխանին…",
  responded: "Վաճառողը պատասխանել է — կարող եք շարունակել զրույցը",
  modal: {
    title: "Նոր հաղորդագրություն",
    subtitle: "Ընտրեք վաճառողին",
    searchPlaceholder: "Փնտրել…",
    step2Title: "Հաղորդագրություն",
    subject: "Թեմա *",
    subjectPlaceholder: "Ինչի մասին է հաղորդագրությունը",
    message: "Հաղորդագրություն *",
    messagePlaceholder: "Նկարագրեք ձեր կարիքները…",
    eventType: "Միջոցառման տեսակ",
    eventTypePlaceholder: "Օրինակ՝ հարսանիք, ծննդյան օր",
    eventDate: "Ամսաթիվ",
