...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://development.salooote.am/${lang}/blog`,
      languages: {
        en: "https://development.salooote.am/en/blog",
        hy: "https://development.salooote.am/hy/blog",
        ru: "https://development.salooote.am/ru/blog",
      },
    },
    openGraph: {
      title: "Blog — Salooote.am",
      description: "Event planning tips, vendor spotlights, and inspiration for your next celebration.",
      url: `https://development.salooote.am/${lang}/blog`,
